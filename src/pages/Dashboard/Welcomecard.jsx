...
export default function WelcomeCard({ user }) {
    ...
    // const referralLink = `http://localhost:3000/register?ref=${user?.superId || referralCode}`;
    const referralLink = `http://localhost:3000/signup`;
    ...
    const perks = [
        { icon: <TrendingUpRounded sx={{ fontSize: 16 }} />, label: "Real-time tracking" },
        { icon: <BoltRounded sx={{ fontSize: 16 }} />, label: "Instant rewards" },
        { icon: <AllInclusiveRounded sx={{ fontSize: 16 }} />, label: "Unlimited invites" },
    ];
        ...
        >
            ...
            >
                ...
                <Box sx={{ position: "relative", zIndex: 1 }}>
                    ...
                    <Typography
                        ...
                        sx={{ fontFamily: "Poppins, sans-serif", fontWeight: 800, lineHeight: 1.15 }}
                    >
                    ...
                    <Stack
                        ...
                        flexWrap="wrap"
                        sx={{ mt: 3.5, rowGap: 1, display: { xs: "none", sm: "flex", }, textAlign: "center", justifyContent: "center", alignItems: "center", }}
                    >
                        {perks.map((p) => (
                            <Stack
                                key={p.label}
            ...
            >
                ...
                >
                    ...
                    <Typography sx={{ mt: 1, fontSize: 13, color: MUTED, lineHeight: 1.6 }}>
                ...
                >
                        ...
                        <Tooltip title={copied ? "Copied!" : "Copy invite link"}>
                            <IconButton
                                ...
                                sx={{
                                    ...
                                    "&:hover": {
                                        bgcolor: copied ? alpha("#16A34A", 0.16) : alpha(INDIGO, 0.14),
                                    },
                                }}
                            >
                    ...
                    <Typography sx={{ mt: 1.5, fontSize: 12, color: MUTED }}>
                        {copied ? "Link copied to clipboard" : "Copy or share your invite link"}
                    </Typography>
                </Box>
            </Box>
        </Box>
