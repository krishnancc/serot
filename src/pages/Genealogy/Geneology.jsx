...
export default function GenealogyView() {
    ...
    const fetchDrillDownline = async (rootUserId, depth = 10) => {
        try {
            ...
            if (res?.error) {
                toast.error(res.message || 'Failed to load drill data');
            } else {
    ...
    const fetchGenealogy = async () => {
        try {
            ...
            if (res?.error) {
                toast.error(res.message || 'Failed to load genealogy data');
                return;
            }
            ...
            >
                ...
                <Box
                    sx={{
                        ...
                        boxShadow:
                            `inset 0 0 15px ${alpha(accent, 0.12)}`,
