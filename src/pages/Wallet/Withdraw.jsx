...
export default function Withdraw({
  ...
  const withdrawSchema = Yup.object({
    ...
    amount: Yup.number()
      ...
      .max(
        availableUsd,
        `Insufficient balance. Available: $${availableUsd.toFixed(2)}`,
      ),
    address: Yup.string()
  ...
  const selectedAsset = useMemo(
    () => crypto.find((a) => String(a.assetId) === withdrawForm.values.assetId),
    [crypto, withdrawForm.values.assetId],
  );

  const estimatedCrypto =
    selectedAsset && withdrawForm.values.amount
      ? (
          Number(withdrawForm.values.amount) / Number(selectedAsset.priceUSD)
        ).toFixed(6)
      : null;
          ...
          <Stack spacing={3}>
            ...
            >
              ...
              >
                ...
                {crypto.filter((a) => a.canWithdraw).length === 0 && (
            ...
            <Stack spacing={0.5}>
              ...
              <TextField
                ...
                onBlur={withdrawForm.handleBlur}
                error={
                  withdrawForm.touched.amount && !!withdrawForm.errors.amount
                }
                helperText={
                  withdrawForm.touched.amount && withdrawForm.errors.amount
                }
                  ...
                  input: {
                    endAdornment: (
                      <Button
                        ...
                        disabled={
                          !withdrawForm.values.assetId || availableUsd <= 0
                        }
                        sx={{
                          minWidth: "auto",
                          px: 1,
