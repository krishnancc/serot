  ...
  const walletData = [
    {
      ...
      value: balances.main?.usd,
      subtitle: `≈ $ ${format(balances.main?.usd)} USDT`,
      icon: <AccountBalanceWalletRoundedIcon />,
      accent: PRIMARY,
    },
    {
      title: "Super Balance",
      value: balances.fund?.usd,
      subtitle: `≈ $ ${format(balances.fund?.usd)} USDT`,
      icon: <AccountBalanceRoundedIcon />,
      accent: SUCCESS,
    },
    {
      title: "Deposit Balance",
      value: balances.deposit?.usd,
      subtitle: `≈ $ ${format(balances.deposit?.usd)} USDT`,
