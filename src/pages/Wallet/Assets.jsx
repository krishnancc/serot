...
const Assets = ({ cryptos, balances, user, handleDepositSync, syncing, handleSuccess }) => {
        ...
        >
            <Grid size={{ xs: 12, sm: 12, md: 7 }}>
                ...
                >
                    ...
                    {tab === 1 && (
                        <>
                            <Withdraw crypto={cryptos} balances={balances} user={user} handleSuccess={handleSuccess} />
                        </>
                    )}
                </Box>
            </Grid>
