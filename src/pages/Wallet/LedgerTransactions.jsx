...
const LedgerTransactions = () => {
    ...
    const totalPages = Math.max(1, Math.ceil(ledgerRowCount / paginationModel.pageSize));
    ...
    return (
        ...
        >
            ...
            >
                <Stack direction="row" spacing={1.5} alignItems="center" sx={{ flex: 1, width: '100%', justifyContent: 'space-between' }}>
                    <Typography fontWeight={900} fontSize={{ xs: 18, sm: 22, md: 24 }} lineHeight={1.15}>
                        Ledger Transactions
                    </Typography>
                ...
                {!isMobile && (
                    <IconButton sx={{ mr: 4.5 }} onClick={fetchLedger} disabled={ledgerLoading}>
                        {ledgerLoading ? (
                        ...
                        <Stack spacing={1}>
                            ...
                            <Stack direction='row' sx={{
                                ...
                                <Typography fontSize={12} sx={{
                                    color: row.entryType === 'CREDIT'
                                        ? '#047857'
                                        : '#B45309',
                                }}>
                                    {row.entryType === 'CREDIT' ? '+' : '-'}{row.amount} {row.currency}
                                </Typography>
                            </Stack>
