        ...
        const fetchDepositAddress = async () => {
            try {
                ...
                if (result?.error || !result?.success) {
                    toast.error(result?.message || 'Failed to fetch deposit address');
                    return;
                }
            ...
            {({ values }) => (
                ...
                >
                    ...
                    <Box mb={{ xs: 3, sm: 3.5 }}>
                        ...
                        <Typography sx={{ color: MUTED, mt: 0.5, fontSize: { xs: 13.5, sm: 14.5 } }}>
                            Fund your wallet by sending assets to the address below.
                        </Typography>
                    </Box>

                    {/* Selectors */}
                    <Grid sx={{ pt: "20px !important", }} container spacing={{ xs: 2, sm: 2.5 }} mb={{ xs: 3, sm: 3.5 }}>
                        <Grid size={{ xs: 12, sm: 6 }}>
                            <SelectorField label="Asset" icon={asset?.icon} value={values.asset} />
                        </Grid>
                        <Grid size={{ xs: 12, sm: 6 }}>
                            <SelectorField
                                label="Network"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Box display="flex" alignItems="center" gap={0.5}>
                                        ...
                                        <Typography sx={{ fontSize: 11.5, color: MUTED, fontWeight: 600 }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <IconButton
                                            ...
                                            sx={{
                                                ...
                                                "&:hover": { bgcolor: copied ? SUCCESS_BG : PRIMARY + "26" },
                                            }}
                                        >
                                    ...
                                    <Box mt={2.5} display="flex" flexDirection="column" gap={1.25}>
                                        <Grid sx={{ pt: "20px !important", }}>
                                            <NoticeStrip
                                                tone="success"
                                                icon={<AccountBalanceWalletRoundedIcon sx={{ fontSize: 18, color: SUCCESS, pt: 0.5 }} />}
                                            >
                                                Only send {values.asset || "this asset"} on the {values.network || "selected"} network to this address.
                                            </NoticeStrip>
                                        </Grid>
                                        ...
                                        <Grid sx={{ pt: "20px !important", }}>
                                            <NoticeStrip
                                                tone="warning"
                                                icon={<WarningAmberRoundedIcon sx={{ fontSize: 18, color: AMBER }} />}
                                            >
                                                Sending a different asset or using another network may permanently lose your funds.
                                            </NoticeStrip>
                                        </Grid>
                                    </Box>
                                </Box>
